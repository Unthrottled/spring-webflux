...
var RemotePodMember = /** @class */ (function () {
     ...
     */
    function RemotePodMember(identifier, remoteProjectFile) {
    ...
    Object.defineProperty(RemotePodMember.prototype, "identifier", {
        get: function () {
     ...
     * @param {File} file
     */
    RemotePodMember.prototype.setNewFile = function (file) {
        //todo: me?
    };
     ...
     */
    RemotePodMember.prototype.imageBinary = function () {
